...
The chunk size starts at 300 jobs and grows 1.5x each round (capped at
1000) to keep chunks small enough that all worker slots stay busy. The
...
The chosen defaults B<buf_growth=1.5, buf_cap=1000> optimise for
